    ...
    sections: [
      {
        ...
        type: "hero",
        title: "Hero carousel",
        help: "N slides: image, title, subtitle. CTAs and plant video.",
      },
      {
        id: "capability",
        type: "capability",
        title: "Capability & stats",
        help: "Company pitch and animated numbers.",
      },
      {
        id: "products",
        type: "products",
        title: "Products band",
        help: "Headings; product cards hydrate from published catalogue.",
      },
      {
        id: "upcoming-products",
        type: "upcoming-products",
        title: "Upcoming products",
        help: "Coming-soon strip from catalogue.",
      },
      {
        id: "markets",
        type: "markets",
        title: "Markets we serve",
        help: "Industry segments grid.",
      },
      {
        id: "mission",
        type: "mission",
        title: "Mission / video",
        help: "Statement over a full-bleed image.",
      },
      {
        id: "cta-banner",
        type: "cta-banner",
        title: "Inquire banner",
        help: "Mid-page call to action.",
      },
      {
        id: "testimonials",
        type: "testimonials",
        title: "Testimonials",
        help: "N partner quotes.",
      },
      {
        id: "customers",
        type: "customers",
        title: "Customers",
        help: "Logo strip (published logos override names).",
      },
      {
        id: "joint-ventures",
        type: "joint-ventures",
        title: "Plant capability / JVs",
        help: "Partnership highlights and image.",
      },
      {
        id: "careers-teaser",
        type: "careers-teaser",
        title: "Careers teaser",
        help: "Employer brand section.",
      },
      {
        id: "faq",
        type: "faq",
        title: "FAQ",
        help: "N accordion questions.",
      },
    ],
  },
  {
